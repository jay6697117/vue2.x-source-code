...
const render1 = compilerToFunction(`<ul style="color: red;background:#ccc;border-top:50px solid purple;">
  <li key="a">a</li>
  <li key="b">b</li>
  <li key="c">c</li>
  <li key="d">d</li>
...
const render2 = compilerToFunction(`<ul style="color: blue;background:#ccc;border-top:50px solid purple;">
  <li key="b">b</li>
  <li key="m">m</li>
  <li key="a">a</li>
  <li key="p">p</li>
