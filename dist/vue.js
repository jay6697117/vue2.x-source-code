(function (global, factory) {
  ...
  */
  ...
  var render1 = compilerToFunction("<ul style=\"color: red;background:#ccc;border-top:50px solid purple;\">\n  <li key=\"a\">a</li>\n  <li key=\"b\">b</li>\n  <li key=\"c\">c</li>\n  <li key=\"d\">d</li>\n</ul>");
  var vm1 = new Vue({
    data: {
      name: '珠峰'
    }
  ...
  var el = createElement(prevVnode);
  document.body.appendChild(el);
  var render2 = compilerToFunction("<ul style=\"color: blue;background:#ccc;border-top:50px solid purple;\">\n  <li key=\"b\">b</li>\n  <li key=\"m\">m</li>\n  <li key=\"a\">a</li>\n  <li key=\"p\">p</li>\n  <li key=\"c\">c</li>\n  <li key=\"q\">q</li>\n</ul>");
  var vm2 = new Vue({
    data: {
      name: '教育'
    }
